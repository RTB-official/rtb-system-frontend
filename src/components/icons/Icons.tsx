...
export const IconCalendar = (props: { className?: string }) => (
    <svg
        ...
        aria-hidden="true"
    >
        {/* 게시판/보고서처럼 채운 실루엣 + 안쪽 디테일(헤더줄·날짜칸) 구멍을 뚫음 */}
        <path
            fill="currentColor"
            fillRule="evenodd"
            clipRule="evenodd"
            d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2ZM7 8h10v1.5H7V8Zm0 4h2.2v2.2H7V12Zm4.4 0h2.2v2.2h-2.2V12Zm4.4 0H18v2.2h-2.2V12ZM7 16.2h2.2V18.4H7v-2.2Zm4.4 0h2.2V18.4h-2.2v-2.2Zm4.4 0H18V18.4h-2.2v-2.2Z"
        />
    </svg>
);
