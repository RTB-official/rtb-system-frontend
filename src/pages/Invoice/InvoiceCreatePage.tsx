                ...
                <div className="flex-1 overflow-y-auto p-6 bg-gray-50">
                    <div className="max-w-full mx-auto h-full">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
                            {/* 좌측: INVOICE 폼 */}
                            <div className="flex flex-col gap-6 bg-white border border-gray-200 rounded-xl p-6 overflow-y-auto">
                                {/* INVOICE 제목 - 크고 굵게 */}
                            ...
                            <div className="flex flex-col gap-6 bg-white border border-gray-200 rounded-xl p-6 overflow-y-auto">
                                {/* TIMESHEET 제목 - 크고 굵게 */}
                                <h2 className="text-3xl font-bold text-black mb-2">TIMESHEET</h2>
                                
                                {/* Job Information Section - 4x2 Card Grid */}
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="border border-gray-300 rounded overflow-x-auto">
                                        <table className="w-full text-xs min-w-[1200px] border-collapse">
                                            <thead className="bg-gray-100">
                                                {/* 1행: Indication of date & time / Split of Hours / Mark Sea-going */}
                                                <tr>
                                                    <th colSpan={7} className="px-2 py-2 text-center font-semibold text-gray-900 border-b border-r border-gray-300">
                                                        Indication of date &amp; time
                                                    </th>
                                                    <th colSpan={6} className="px-2 py-2 text-center font-semibold text-gray-900 border-b border-r border-gray-300">
                                                        Split of Hours
                                                    </th>
                                                    <th rowSpan={3} className="px-2 py-2 text-center font-semibold text-gray-900 border-b border-gray-300">
                                                        Mark Sea-going<br />Vessel (x)
                                                    </th>
                                                </tr>
                                                {/* 2행: Year~Total Hours + 상위 그룹 헤더 */}
                                                <tr>
                                                    <th className="px-2 py-2 text-center font-semibold text-gray-900 border-b border-r border-gray-300">
                                                        Year
                                                    </th>
                                                    <th className="px-2 py-2 text-center font-semibold text-gray-900 border-b border-r border-gray-300">
                                                        Day
                                                    ...
                                                    <th className="px-2 py-2 text-center border-b border-r border-gray-300" />
                                                    <th colSpan={2} className="px-2 py-1 text-center font-medium text-gray-700 border-b border-r border-gray-300">
                                                        Weekdays<br />(with in normal working hours,<br />08:00 to 17:00)
                                                    </th>
                                                    <th colSpan={2} className="px-2 py-1 text-center font-medium text-gray-700 border-b border-r border-gray-300">
                                                        Saturday, Sunday,<br />and local holidays
                                                    </th>
                                                    <th colSpan={2} className="px-2 py-1 text-center font-medium text-gray-700 border-b border-r border-gray-300">
                                                        Travel Hours**
                                                    </th>
                                                </tr>
                                                {/* 3행: Split of Hours 하위 라벨 */}
                                                <tr>
                                                    <th className="px-2 py-1 text-center border-b border-r border-gray-300" />
                                                    <th className="px-2 py-1 text-center border-b border-r border-gray-300" />
                                                    <th className="px-2 py-1 text-center border-b border-r border-gray-300" />
                                                    <th className="px-2 py-1 text-center border-b border-r border-gray-300" />
                                                    <th className="px-2 py-1 text-center border-b border-r border-gray-300" />
                                                    <th className="px-2 py-1 text-center border-b border-r border-gray-300" />
                                                    <th className="px-2 py-1 text-center border-b border-r border-gray-300" />
                                                    <th className="px-2 py-1 text-center font-medium text-gray-700 border-b border-r border-gray-300">
                                                        Normal Working
                                                    </th>
                                                    <th className="px-2 py-1 text-center font-medium text-gray-700 border-b border-r border-gray-300">
                                            ...
                                            <tbody>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    ...
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">2026</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Fri</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">02.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">06</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">19</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">12</td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    <td colSpan={7} className="px-2 py-1 text-left text-xs text-gray-600 border-r border-gray-300"></td>
                                                    <td colSpan={6} className="px-2 py-1 text-left text-xs text-gray-600">KT On / skilled fitter and 2 fitters</td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Sat</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">03.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">13</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">24</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">11</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    <td colSpan={7} className="px-2 py-1 text-left text-xs text-gray-600 border-r border-gray-300"></td>
                                                    <td colSpan={6} className="px-2 py-1 text-left text-xs text-gray-600">KT On / skilled fitter and 5 fitters</td>
                                                    <td className="px-2 py-1"></td>
                                                </tr>
                                                {/* Row 3: Sun, 04.Jan */}
                                                <tr className="border-b border-gray-300">
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Sun</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">04.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">00</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">03</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">3</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Tue</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">06.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">06</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">19</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">12</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">8</td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Mon</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">12.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">06</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">13</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">7</td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    <td colSpan={7} className="px-2 py-1 text-left text-xs text-gray-600 border-r border-gray-300"></td>
                                                    <td colSpan={6} className="px-2 py-1 text-left text-xs text-gray-600">KT On / skilled fitter and 1 fitter</td>
                                                    <td className="px-2 py-1"></td>
                                                </tr>
                                                {/* Row 6: Sat, 17.Jan */}
                                                <tr className="border-b border-gray-300">
                                                    ...
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Sat</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">17.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">06</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">16</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">10</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    ...
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Tue</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">27.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">06</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">15</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">9</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">2</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">4</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    <td colSpan={7} className="px-2 py-1 text-left text-xs text-gray-600 border-r border-gray-300"></td>
                                                    <td colSpan={6} className="px-2 py-1 text-left text-xs text-gray-600">JH Ahn / skilled fitter and 4 fitters</td>
                                                    <td className="px-2 py-1"></td>
                                                </tr>
                                                {/* Row 8: Wed, 28.Jan */}
                                                <tr className="border-b border-gray-300">
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Wed</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">28.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">06</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">13</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">7</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">4</td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    ...
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Fri</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">30.Jan</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">06</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">16</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300 font-bold">10</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">6</td>
                                                ...
                                                <tr className="border-b border-gray-300">
                                                    <td colSpan={7} className="px-2 py-1 text-left text-xs text-gray-600 border-r border-gray-300"></td>
                                                    <td colSpan={6} className="px-2 py-1 text-left text-xs text-gray-600">JH Ahn / skilled fitter and 3 fitters</td>
                                                    <td className="px-2 py-1"></td>
                                                </tr>
                                                {/* 빈 행들 */}
                                                ...
                                                <tr className="bg-gray-100 font-semibold">
                                                    <td className="px-2 py-2 text-center border-r border-gray-300">Total</td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
                                                    <td className="px-2 py-2 text-center border-r border-gray-300"></td>
